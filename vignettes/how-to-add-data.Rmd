---
title: "How to add a data set to textdata"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to add a data set to textdata}
...
This package provides infrastructue to make text datasets available within R, even when they are too large to store within an R package or are licensed in such a way that prevents them from being included in OSS-licensed packages.
