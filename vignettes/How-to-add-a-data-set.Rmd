...
For datasets that comes with a testing and training dataset. Let the user pick whick one to retrive with a `split` argument similar to how `dataset_ag_news()` is doing.
